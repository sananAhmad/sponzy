        ...
        <table class="table table-borderless table-striped">
          ...
          <tr>
            ...
            @if ($data->type == 'subscription')
              <td class="text-center">{{trans('general.subscription_for').' @'.$data->subscribed()->username}}</td>
            @elseif ($data->type == 'ppv')
              <td class="text-center">{{trans('general.ppv').' @'.$data->subscribed()->username}}</td>
            @elseif ($data->type == 'purchase')
              <td class="text-center">{{trans('general.purchase_item').' @'.$data->subscribed()->username}}</td>
            @else
              <td class="text-center">{{trans('general.single_payment').' ('.trans('general.tip').') @'.$data->subscribed()->username}}</td>
            @endif
