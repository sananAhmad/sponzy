       ...
       <fieldset class="row mb-3">
         ...
         <div class="col-sm-10">
           <div class="form-check">
             <input class="form-check-input" type="radio" name="app_debug" id="radio1" @if (env('APP_DEBUG') == true) checked="checked" @endif value="true">
           ...
           <div class="form-check">
             <input class="form-check-input" type="radio" name="app_debug" id="radio2" @if (env('APP_DEBUG') == false) checked="checked" @endif value="false">
