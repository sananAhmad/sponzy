	...
	<div class="row">
		...
		<div class="col-lg-12 mt-3 py-4">
			 <div class="card shadow-custom border-0">
				 <div class="card-body">
					 <h6 class="mb-4 fw-light">{{ __('general.statistics_of_the_month') }}</h6>
		...
		<div class="col-lg-6 mt-0 mt-lg-3 py-4">
			 <div class="card shadow-custom border-0">
				 <div class="card-body">
					 <h6 class="mb-4 fw-light">{{ __('general.subscriptions_the_month') }}</h6>
					 <div style="height: 350px">
		...
		<div class="col-lg-6 mt-3 py-4">
			 <div class="card shadow-custom border-0">
				 <div class="card-body">
					 <h6 class="mb-4 fw-light">{{ trans('admin.user_countries') }}</h6>
		...
		<div class="col-lg-6 mt-0 mt-lg-3 py-4">
			 <div class="card shadow-custom border-0">
				 <div class="card-body">
					 <h6 class="mb-4 fw-light">{{ __('admin.latest_members') }}</h6>
		...
		<div class="col-lg-6 mt-0 mt-lg-3 py-4">
			 <div class="card shadow-custom border-0">
				 <div class="card-body">
					 <h6 class="mb-4 fw-light">{{ __('admin.recent_subscriptions') }}</h6>
