...
Route::get('verify/account/{confirmation_code}', 'HomeController@getVerifyAccount')->where('confirmation_code','[A-Za-z0-9]+');
 ...
 Route::group(['middleware' => 'auth'], function() {
	...
	Route::post('subscription/paypal/cancel/{id}','PayPalController@cancelSubscription');
	...
	// Likes
	Route::get('my/likes','UserController@myLikes');
	Route::get('ajax/user/likes', 'UserController@ajaxMyLikes');
	...
	// Report Item (Shop)
	Route::post('report/item/{id}', 'ProductsController@report');
...
Route::group(['middleware' => 'private.content'], function() {
 ...
 Route::group(['middleware' => 'role'], function() {
	...
	// Test SMTP
	Route::post('panel/admin/settings/test-smtp','AdminController@testSMTP');
  ...
  Route::view('panel/admin/pwa','admin.pwa')->name('pwa');
	...
	// Shop Categories
 	Route::get('panel/admin/shop-categories','AdminController@shopCategories')->name('shop_categories');
 	Route::get('panel/admin/shop-categories/add','AdminController@addShopCategories')->name('shop_categories');
 	Route::post('panel/admin/shop-categories/add','AdminController@storeShopCategories');
 	Route::get('panel/admin/shop-categories/edit/{id}','AdminController@editShopCategories')->name('shop_categories');
 	Route::post('panel/admin/shop-categories/update','AdminController@updateShopCategories');
 	Route::post('panel/admin/shop-categories/delete/{id}','AdminController@deleteShopCategories');
...
Route::get('add/physical/product','ProductsController@createPhysicalProduct')->middleware('auth');
Route::post('add/physical/product','ProductsController@storePhysicalProduct')->middleware('auth');
...
// PayPal Webhook
Route::post('webhook/paypal', 'PayPalController@webhook');
